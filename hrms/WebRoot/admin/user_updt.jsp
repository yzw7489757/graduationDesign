            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form role="form" class="form-horizontal m-t" action="<%=path %>/admin/user_updt_post.jsp?id=<%=id %>" method="post" onsubmit="return checks();" >
                            <div class="form-group draggable">
                                <label class="col-sm-3 control-label">用户名<b style="color: red;"> *</b>：</label>
                                <div class="col-sm-4">
                                    <input type="text" name="uid" id="uid"  value="<%=id %>" class="form-control"  readonly="readonly">
                                </div>
                            </div>
                            <div class="form-group draggable">
                                <label class="col-sm-3 control-label">密码<b style="color: red;"> *</b>：</label>
                                <div class="col-sm-4">
                                    <input type="text"  name="mima" id="mima" value="<%=mima %>" class="form-control" name="password" placeholder="请输入密码">
                                </div>
                            </div>
                            <div class="form-group draggable">
                                <label class="col-sm-3 control-label">姓名<b style="color: red;"> *</b>：</label>
                                <div class="col-sm-4">
                                    <input type="text" name="name"  id="name"value="<%=name %>" class="form-control" placeholder="请输入姓名">
                                </div>
                            </div>
                            <div class="form-group draggable">
