            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
					   ...
					   <div class="col-md-12">
					   		<form action="<%=path %>/admin/getAllJob.do" method="post">
					     <div class="form-group">
					        ...
					        <div class="col-sm-4" align="left">
					            <button onclick="javascript:window.location.href='<%=path%>/admin/job_add.jsp'" class="btn btn-primary"  type="button"  >新增</button>
                        ...
                        <table class="table table-striped table-bordered table-hover ">
                            ...
                            <%
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td><a href="<%=path %>/admin/job_updt.jsp?id=<%=u.getId()%>">修改</a> <a href="<%=path %>/admin/del.jsp?id=<%=u.getId() %>&tablename=job" onClick="return confirm('真的要删除？')">删除</a></td>
                                </tr>
                                <%} %>
                        </table>
