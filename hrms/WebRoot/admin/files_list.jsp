                    ...
                    <div class="ibox-title">
					   ...
					   <div class="col-md-12">
					     ...
					     <div class="form-group">
					        <div class="col-sm-4">
					            <input type="text" name="name" class="form-control" placeholder="请输入文件标题">
					        </div>
					        ...
					        <div class="col-sm-4" align="left">
					            <button onclick="javascript:window.location.href='<%=path%>/admin/files_add.jsp'" class="btn btn-primary"  type="button"  >新增</button>
                        ...
                        <table class="table table-striped table-bordered table-hover ">
                            ...
                            <%
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td class="center"><a href="<%=path+"/upload/"+u.getUrls() %>">下载文件</a></td>
                                    <td><a href="<%=path %>/admin/del.jsp?id=<%=u.getId() %>&tablename=files" onClick="return confirm('真的要删除？')">删除</a></td>
                                </tr>
                                <%} %>
                        </table>
