            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
					   ...
					   <div class="col-md-12">
					   		<form action="<%=path %>/admin/getAllEmp.do" method="post">
					     <div class="form-group">
					        <div class="col-sm-2">
					            <input type="text" name="name" class="form-control" placeholder="姓名">
					        </div>
					        <div class="col-sm-2">
					            <input type="text" name="idcard" class="form-control" placeholder="身份证">
					        </div>
					        <div class="col-sm-2">
					        ...
					        <div class="col-sm-3" align="left">
					            <button onclick="javascript:window.location.href='<%=path%>/admin/emp_add.jsp'" class="btn btn-primary"  type="button"  >新增</button>
                        ...
                        <table class="table table-striped table-bordered table-hover ">
                            ...
                            <%
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td class="center"><%=u.getSex() %></td>
                                    <td class="center"><%=u.getName() %></td>
                                    <td class="center"><%=u.getTel() %></td>
                                    <td class="center"><%=u.getMail() %></td>
                                    <td class="center"><%=u.getBirth() %></td>
                                    <td class="center"><%=u.getMark() %></td>
                                    <td class="center"><%=u.getIdcard() %></td>
                                    <td class="center"><%=u.getJob() %></td>
                                    <td class="center"><%=u.getDept() %></td>
                                    <td><a href="<%=path %>/admin/emp_updt.jsp?id=<%=u.getId()%>">修改</a> <a href="<%=path %>/admin/del.jsp?id=<%=u.getId() %>&tablename=users" onClick="return confirm('真的要删除？')">删除</a></td>
                                </tr>
                                <%} %>
                        </table>
