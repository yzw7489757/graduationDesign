            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form role="form" class="form-horizontal m-t" action="<%=path %>/admin/user_add_post.jsp" method="post" onsubmit="return checks();" >
                            <div class="form-group draggable">
                                <label class="col-sm-3 control-label">密码<b style="color: red;"> *</b>：</label>
                                <div class="col-sm-4">
                                    <input type="password"  name="mima" id="mima" class="form-control" name="password" placeholder="请输入密码">
                                </div>
                            </div>
                            <div class="form-group draggable">
