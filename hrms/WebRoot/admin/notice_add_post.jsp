...
<jsp:useBean id="connDbBean" scope="page" class="db.db"/>
	 <%
	 String id="1001";
	 ResultSet RS_result=connDbBean.executeQuery("select max(id)   as id from notice   ");
	 ...
	 String sql="insert into notice(id,name,content,savetime,user) values('"+uid+"','"+name+"','"+content+"','"+time+"','"+u.getName()+"') ";
